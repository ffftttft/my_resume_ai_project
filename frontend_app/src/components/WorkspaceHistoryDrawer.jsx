  ...
  return (
    <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
      ...
      {analysisNotes.length > 0 ? (
        <ul className="custom-scrollbar mt-4 max-h-72 space-y-3 overflow-y-auto overscroll-contain pr-1">
  ...
  return (
    <AnimatePresence>
      {open ? (
        ...
        >
          <motion.aside
            className="history-drawer__panel flex flex-col overflow-hidden border border-gray-200 bg-gray-50 shadow-2xl"
            initial={{ x: "100%" }}
            animate={{ x: 0 }}
            exit={{ x: "100%" }}
          ...
          >
            ...
            <div className="history-drawer__body min-h-0 flex-1 overflow-hidden px-5 py-5">
