    ...
    <section className="paper-panel p-6 lg:p-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h2 className="mt-2 text-3xl font-semibold text-[var(--ink)]">{title || "等待生成简历"}</h2>
          <div className="mt-3 flex flex-wrap gap-2">
            <span className="chip accent-chip">
              {generationMode === "openai" ? "AI 模式" : "本地兜底模式"}
            </span>
      ...
      <div className="space-y-5">
        ...
        {analysisNotes?.length > 0 && (
          <div className="rounded-[24px] border border-slate-200 bg-white/70 p-5">
            <p className="mb-3 text-sm font-semibold tracking-[0.24em] text-[var(--muted)] uppercase">
              生成说明
            </p>
        ...
        <div className="rounded-[24px] border border-slate-200 bg-white/72 p-5">
          <div className="mb-3">
            ...
            <p className="mt-2 text-sm text-[var(--muted)]">
              这里填写你希望 AI 继续优化的方向，例如更贴近岗位、更强调成果，或进一步精简表达。
            </p>
          </div>
          ...
          <div className="relative">
            <textarea
              ...
              placeholder="例如：更突出工程化、性能优化结果，并按招聘要求重排重点。"
            />
            <button
              type="button"
